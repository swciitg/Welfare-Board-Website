...
const add_clubs_info = async () => {
  ...
  for (let i = 0; i < clubs.length; i++) {
    temp_clubs += `  <li class="nav-item">
           <a class="nav-link" id=club_${clubs[i]._id} onclick=change_club("${clubs[i]._id}") href="https://iitg.ac.in/stud/gymkhana/welfareBoard" style="font-family: Raleway;font-size:16px;font-style:normal;font-weight:normal;line-height:19px;">${clubs[i].name}</a>
           </li>
        `
  }
  var index
